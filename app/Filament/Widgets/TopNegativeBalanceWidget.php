...
<a href="' . htmlspecialchars($whatsappUrl, ENT_QUOTES, 'UTF-8') . '" 
   ...
   class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#25D366] rounded-lg hover:bg-[#128C7E] transition-all duration-200 shadow-sm">
    WhatsApp Remind test
</a>';
                    })
                    ->html()
                    ->alignCenter()
