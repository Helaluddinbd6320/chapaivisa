            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('whatsapp_action')
                    ...
                    ->getStateUsing(function ($record) {
                        ...
                        // WhatsApp message with emojis/icons
                        $message = "👋 *Hello {$name},*\n\n";
                        $message .= "💰 *Your Current Balance:* {$formattedBalance} ৳\n";
                        $message .= "⚠️ *Status:* Due Amount\n\n";
                        $message .= "📝 *Details:*\n";
                        $message .= "--------------------------------\n";
                        $message .= "• Amount Due: {$formattedBalance} ৳\n";
                        $message .= "• Payment Status: ❌ Pending\n\n";
                        $message .= "🙏 *Request:*\n";
                        $message .= "Please clear your dues at your earliest convenience to avoid any inconvenience.\n\n";
                        $message .= "💳 *Payment Methods:*\n";
                        $message .= "• Bank Transfer\n";
                        $message .= "• Cash Payment\n";
                        $message .= "• Mobile Banking\n\n";
                        $message .= "📞 *Contact for Support:*\n";
                        $message .= "• Phone: [Your Company Phone]\n";
                        $message .= "• Email: [Your Company Email]\n\n";
                        $message .= "Thank you for your cooperation! 🙏\n";
                        $message .= "Best Regards,\n";
                        $message .= "[Your Company Name] Team 🏢";
