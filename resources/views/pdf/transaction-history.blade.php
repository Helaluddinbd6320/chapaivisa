...
<head>
    ...
    <style>
        ...
        .header td, .footer td { border: none; text-align: left; padding: 2px; font-size: 12px; }
...
<table class="footer">
    <tr>
        ...
        <td><strong>Phone 2:</strong> {{ $settings->office_phone2 ?? '-' }}</td>
    </tr>
    <tr>
