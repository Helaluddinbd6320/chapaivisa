@php
    ...
    $message = "\u{1F31F} *Visa Office Chapai International* \u{1F31F}\n\n";
    $message .= "\u{1F4CB} *BALANCE REMINDER NOTIFICATION*\n\n";
    $message .= "Dear *{$name}*,\n\n";
    $message .= "Your account has an outstanding balance:\n\n";
    $message .= "\u{1F4B0} *Amount Due:* -{$formattedBalance}৳\n";
    $message .= "\u{1F4CA} *Status:* Payment Required\n";
    $message .= "\u{1F4C5} *Date:* " . date('d/m/Y') . "\n\n";
    $message .= "━━━━━━━━━━━━━━━━━━━━\n";
    $message .= "\u{1F4B3} *PAYMENT OPTIONS:*\n";
    $message .= "• Cash payment at our office\n";
    $message .= "• Bank transfer\n";
    $message .= "• Mobile banking (bKash, Nagad, Rocket)\n\n";
    $message .= "\u{1F3E2} *OFFICE INFORMATION:*\n";
...
<div class="flex flex-col items-center gap-1 py-1">
    <a href="{{ $whatsappUrl }}" onclick="window.open(this.href, '_blank', 'noopener,noreferrer'); return false;"
